...
INSERT INTO tb_protocol (name, proto_type, url, mark, proto_key, handler_class, script_content, script_lang, status)
VALUES ('Modbus TCP', 2, '', 'Modbus TCP polling driver', 'modbus-tcp', 'com.github.dingdaoyi.driver.modbus.ModbusProtocolDecoder', NULL, NULL, 1);
...
CREATE TABLE tb_rule_execution_log (
    id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
